(function($) {
    window.emailOctopus = {
        ...
        showConfirmation: function($form, response) {
            console.log("this is the successMessage: ", emailOctopus.successMessage)
            // var message = response.message ? response.message : emailOctopus.successMessage;
            if (response.message && response.success == true) {
                message = emailOctopus.successMessage
            }
            // console.log("and this is message: ", message, response)
            $form.trigger("reset");
            $form.find(':submit').removeAttr('disabled');
            $form.siblings('.email-octopus-success-message').text(message);
        },
